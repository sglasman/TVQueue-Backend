...
getSeriesRequest seriesId = Request NoReqBody GET [] $ https "api.thetvdb.com" /: "series" /: fromString (show seriesId)

getEpisodesRequest :: Int -> Int -> Request NoReqBody GetEpisodesResponse GET
getEpisodesRequest seriesId page = Request NoReqBody GET [("page", show page)] $ 
